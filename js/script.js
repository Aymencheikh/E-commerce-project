                            ...
                            <td>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p>${searchProductById(myOrdersTab[i].idProduct).name}</p>
                                        </div>
                                    </div>
                                </td>
                                <td>
...
function editProduct(id) {
  ...
  <div>
      <div class="col-md-12 form-group">
          <input type="text" class="form-control" value= "${product.name}" id="newName">
     </div>
      <div class="col-md-12 form-group">
  ...
  for (let i = 0; i < ordersTab.length; i++) {
    result =
      ...
      ` <tr>
          ...
          <td>
            <button class="btn btn-success">Cinfirm</button>
          </td>
      </tr>`;
  }
